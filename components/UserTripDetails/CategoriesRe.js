...
// // Function to fetch photo reference for a place
...
//     console.log("Place search result for", placeName, ":", result.status);
...
//     } else {
//       console.log("No photo reference found for", placeName);
//       return null;
//     }
//   } catch (error) {
...
//     const photoReference = await GetPhotoRef(category);
...
//   // Function to fetch photos for all recommendations
...
//                   <Image
//                     source={{
//                       uri: getPhotoUrl(categoryPhotoRef),
//                     }}
