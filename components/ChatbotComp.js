...
// Change from default export screen to component with props
export default function ChatBot({ onClose, containerStyle = {} }) {
        ...
        >
          {messages.length === 0 ? (
            <View style={styles.welcomeContainer}>
              <Text style={styles.welcomeTitle}>Travel Assistant</Text>
              <Text style={styles.welcomeText}>
                Ask me anything about your trips, currency conversion, travel
